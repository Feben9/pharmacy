                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">011</th>
                                <td class="px-4 py-3">Amoxicillin</td>
                                <td class="px-4 py-3">453.00</td>
                                <td class="px-4 py-3">45</td>
                                <td class="px-4 py-3">Some description</td>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">012</th>
                                <td class="px-4 py-3">Tetracyclin</td>
                                <td class="px-4 py-3">453.00</td>
                                <td class="px-4 py-3">45</td>
                                <td class="px-4 py-3">Some description</td>
                                <td class="px-4 py-3">branch 4</td>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">013</th>
                                <td class="px-4 py-3">Panadol</td>
                                <td class="px-4 py-3">453.00</td>
                                <td class="px-4 py-3">45</td>
                                <td class="px-4 py-3">Some description</td>
                                <td class="px-4 py-3">branch 1</td>
                                <td class="px-4 py-3">China</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="apple-imac-27-dropdown-button" data-dropdown-toggle="apple-imac-27-dropdown" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">014</th>
                                <td class="px-4 py-3">Goffen</td>
                                <td class="px-4 py-3">453.00</td>
                                <td class="px-4 py-3">45</td>
                                <td class="px-4 py-3">Some description</td>
                                <td class="px-4 py-3">branch 6</td>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">015</th>
                                <td class="px-4 py-3">Diclofenac</td>
                                <td class="px-4 py-3">453.00</td>
                                <td class="px-4 py-3">45</td>
                                <td class="px-4 py-3">Some description</td>
                                <td class="px-4 py-3">branch 2</td>
                                <td class="px-4 py-3">Kenya</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="apple-imac-27-dropdown-button" data-dropdown-toggle="apple-imac-27-dropdown" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">016</th>
                                <td class="px-4 py-3">Penicilin</td>
                                <td class="px-4 py-3">453.00</td>
                                <td class="px-4 py-3">45</td>
                                <td class="px-4 py-3">Some description</td>
                                <td class="px-4 py-3">branch 1</td>
